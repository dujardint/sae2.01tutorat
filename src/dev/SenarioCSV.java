...
public class SenarioCSV {
	...
	public static void main(String[] args) {
		...
		System.out.println("Merci d'avoir utilisÈ notre merveilleuse application !");
		scan.close();
	}
	...
	public static ArrayList<Tutore> ExtractiongroupeTutoreCSV(String sourceFile) {
		try {
			...
			//System.out.println("Probl√®me √† la fermeture du flux.");
		}
		return null;
	}
